...
// console.log(results.filter(order => order.order.freight < 1));
...
// console.log(results.filter(order => order.orderDetails.length > 3));

// 5) İD-si 11075 olanı tap və yazdır. (find)
// console.log(results.filter(order=>order.order.id === 11075));